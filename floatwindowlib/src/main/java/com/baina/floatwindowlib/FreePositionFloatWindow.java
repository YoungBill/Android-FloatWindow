 ...
 * 自由位置的悬浮窗
 * FloatWindow in a free position
 */

public class FreePositionFloatWindow {
    ...
    public FreePositionFloatWindow(Context context, int touchLocation, View popView) {
        mContext = context;
    ...
    public FreePositionFloatWindow(Context context, View popView) {
        mContext = context;
        initFloatView(context);
        initPopupWindow(popView);
    }
