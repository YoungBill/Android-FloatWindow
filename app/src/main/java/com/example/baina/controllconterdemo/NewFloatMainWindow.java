...
public class NewFloatMainWindow {
    ...
    private static final String TAG = NewFloatMainWindow.class.getSimpleName();
    private static NewFloatMainWindow floatMainWindow;
    ...
    public NewFloatMainWindow(Context context, int touchLocation, View popView) {
        mContext = context;
    ...
    public static NewFloatMainWindow getFloatMainWindow(Context context, int touchLocation, View popView) {
        if (floatMainWindow == null) {
            synchronized (NewFloatMainWindow.class) {
                if (floatMainWindow == null) {
                    floatMainWindow = new NewFloatMainWindow(context, touchLocation, popView);
                }
            }
        } else {
    ...
    private void initFloatView(Context context) {
        mFloatView = new FloatView(context, new OnFlingListener() {
            ...
            public void onSlideUp() {
                ...
                mPopupWindow.showAtLocation(mFloatView, Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, 0);
            }
            ...
            public void onSlideLeft() {
                ...
                mPopupWindow.showAtLocation(mFloatView, Gravity.END, 0, 0);
            }
            ...
            public void onSlideRight() {
                ...
                mPopupWindow.showAtLocation(mFloatView, Gravity.START, 0, 0);
            }
        });
    }
